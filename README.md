...
```bash
$ npm install --save react-native-scrolling
```

or

```bash
$ yarn add react-native-scrolling
```
...
[Pull requests](https://github.com/Luehang/react-native-scrolling/pulls) are welcomed.
...
Not sure where to start, or a beginner? Take a look at the [issues page](https://github.com/Luehang/react-native-scrolling/issues).
